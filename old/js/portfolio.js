window.onload = function(){
    ...
    const CHAR_CROSS_PX = CHAR_SPEED / Math.sqrt(2); //대각선 이동 속도
    ...
    function keyDown(){ // 키가 눌리면 setTimeOut 루프 시작
        ...
        switch (key.keyCode()) {
            case 1: //up
                move.moveTo(0,-CHAR_SPEED);
                break;
            case 2: //left
                move.moveTo(-CHAR_SPEED,0);
                break;
            case 4: //down
                move.moveTo(0,CHAR_SPEED);
                break;
    ...
    function touchFunc(){ //터치관련 클로저
        ...
        return{
            ...
            move : function(){
                ...
                function repeatMove(){
                    move.moveTo(moveInfo.x*CHAR_SPEED,moveInfo.y*CHAR_SPEED);
